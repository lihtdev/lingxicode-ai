 ...
 * 编辑器右键「评审代码」入口。
 *
 * 优先评审选中的代码块，否则评审光标所在的类 / 方法 / 函数；
 * 采集失败（无有效目标）时由 [ReviewCodeStarter] 给出警告通知，不发起请求。
 *
...
class ReviewCodeAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        ReviewCodeStarter.trigger(project, CodeContextBuilder.build(e))
    }
    ...
    override fun update(e: AnActionEvent) {
        ...
        e.presentation.setText(LingxiCodeBundle.message("action.reviewCode.text"))
        e.presentation.setDescription(LingxiCodeBundle.message("action.reviewCode.description"))
    }
