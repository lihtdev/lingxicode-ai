...
fun providerPlanTypeLabel(type: ProviderPlanType): String = when (type) {
    ProviderPlanType.TOKEN_PLAN -> LingxiCodeBundle.message("provider.type.tokenPlan")
    ProviderPlanType.CODING_PLAN -> LingxiCodeBundle.message("provider.type.codingPlan")
    ProviderPlanType.PAY_AS_YOU_GO -> LingxiCodeBundle.message("provider.type.payAsYouGo")
}