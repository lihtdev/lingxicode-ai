...
class ModelSwitcherWidgetFactory : StatusBarWidgetFactory {
    ...
    override fun getId(): String = "lingxicode.modelSwitcher"

    override fun getDisplayName(): String = LingxiCodeBundle.message("statusbar.modelSwitcher.tooltip")
...
class ModelSwitcherWidget(private val project: Project) : StatusBarWidget {
    ...
    private val icon: Icon by lazy {
        IconLoader.getIcon("/icons/lingxicode.svg", ModelSwitcherWidget::class.java)
    }
    ...
    private fun currentTooltip(): String {
        ...
        return if (provider != null) {
            ...
            LingxiCodeBundle.message("statusbar.modelSwitcher.noProvider")
        }
    }

    override fun ID(): String = "lingxicode.modelSwitcher"
...
interface AppSettingsListener {
    ...
    companion object {
        ...
        val TOPIC = com.intellij.util.messages.Topic.create(
            "LingxiCode AI Settings Changes",
