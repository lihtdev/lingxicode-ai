...
import com.lihtdev.codesense.code.SymbolKindDetector
...
class ExplainCodeLineMarkerProvider : LineMarkerProvider {
    ...
    override fun getLineMarkerInfo(element: PsiElement): LineMarkerInfo<PsiElement>? {
        ...
        return LineMarkerInfo(
            ...
            element.textRange,
            ICON,
            { _: PsiElement -> CodeSenseBundle.message("explain.marker.tooltip") },
            ...
            { CodeSenseBundle.message("explain.marker.tooltip") },
        )
    }

    companion object {
        private val ICON = IconLoader.getIcon("/icons/codesense-gutter.svg", ExplainCodeLineMarkerProvider::class.java)
    }
}